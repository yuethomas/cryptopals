...
import binascii
from set_1 import c05_repeating_key_xor_cipher as repeating_key_xor_cipher
...
class TestRepeatingKeyXorCipher(unittest.TestCase):
  ...
  def test_predefined_string(self):
    ...
    input_key = bytearray('ICE')
    output_bin = bytearray(binascii.unhexlify(
    ...
    self.assertEqual(repeating_key_xor_cipher.repeating_key_xor_cipher(input_str, input_key), output_bin)
